...
impl Renderer {
    ...
    pub fn create_tex(&mut self, format: TextureFormat, width: u32, height: u32, pixels: &[u8]) -> TextureId {
    ...
    pub fn update_tex(&mut self, texture: TextureId, x: u32, y: u32, width: u32, height: u32, pixels: &[u8]) {
